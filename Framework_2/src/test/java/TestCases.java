...
public class TestCases {
    ...
    private final String FLYOUTMONTH = "01";
    private final String FLYOUTYEAR = "2019";
    private final String FLYBACKDAY = "29";
    private final String FLYBACKMONTH = "01";
    private final String FLYBACKYEAR = "2019";
